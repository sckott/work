library(XML); library(stringr); library(ggplot2)
temp <- htmlParse("/Mac/JEcol_blog/data_posts/blogstats/sitestats.html")
...
dat <- dat[!dat$titles == "Home page / Archives",] # remove home page views
